...
<div class="main-header">
    ...
    <p>Tác giả: Đặng Văn Ngân - Trường Tiểu học Tân Loan - ĐT: 0333805536</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đặng Văn Ngân-Trường Tiểu học Tân Loan - ĐT: 0333805536</div>", unsafe_allow_html=True)
